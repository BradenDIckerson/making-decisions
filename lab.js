...
//   console.log ("Amy & Brittanis were born in the same year.")
// }
...
if (temperature >= 80 && rain === true) {
  ...
  console.log (" Wear a t-shirt and wear some roller blades")
}
  ...
  console.log ("Wear a jacket and walk your dog.")
}

else {
  console.log ("Go check the weather channel.")
}
